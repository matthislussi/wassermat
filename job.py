...
def getData():
    ...
    sensorData['humidity'] = random.randint(30,61)
    sensorData['pump_active'] = bool(random.getrandbits(1))
    sensorData['light_active'] = bool(random.getrandbits(1))
...
def on_message(unused_client, unused_userdata, message):
    ...
    if (message.topic == '/devices/raspi1/config'):
        ...
        print('Received message \'{}\' on topic \'{}\' with Qos {}'.format(
            limit, message.topic, str(message.qos)))
